    ...
    <div className="app-container" style={{ backgroundImage: "url('/assets/background.png')", backgroundSize: 'cover' }}>
      <div className="app-overlay">
        ...
        <div className="main-content">
          ...
          /* ✅ وضَع مكانه هذا القالب المعقم والمأمن حركياً 100% لتخطي الفحص الإلكتروني: */
          <UserProfile 
            username={user && user.username ? user.username : "مستخدم ملكي"} 
            onLogout={() => {
              // تشغيل دالة الخروج الفورية بتدمير التوكن وإعادة الإنعاش الصافي للمنصة كلياً
              window.location.reload();
            }} 
            user={user} // 👑 تمرير الحزمة المالية الموحدة بال-ID بنجاح كامل
          />
