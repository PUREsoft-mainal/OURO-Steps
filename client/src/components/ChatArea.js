    ...
    <main className="chat-area">
      ...
      <form className="input-box" onSubmit={send} style={{ display: 'flex', gap: '8px', alignItems: 'center', position: 'relative' }}>
        ...
        <button 
          type="button"
          className="assign-btn-gold"
          style={{ width: '15px', height: '15px', fontSize: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', borderRadius: '8px', background: 'linear-gradient(135deg, #1c1c1c 0%, #0d0d0d 100%)', border: '1px solid var(--gold-primary)', color: 'var(--gold-primary)' }}
          onClick={() => {
